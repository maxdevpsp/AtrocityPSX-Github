...
static const CharFrame char_bf_frame[] = {
	{BF_ArcMain_BF0, {  0,   0, 128,  128}, { 60,  120}}, //0 idle 1
	{BF_ArcMain_BF0, {128,   0, 128,  128}, { 60,  120}}, //1 idle 2
	{BF_ArcMain_BF0, {  0, 128, 128,  128}, { 60,  120}}, //2 idle 3
	{BF_ArcMain_BF0, {128, 128, 128,  128}, { 60,  120}}, //3 idle 4
	
	{BF_ArcMain_BF1, {  0,   0,  128,  128}, { 60,  120}}, //5 left 1
	{BF_ArcMain_BF1, {  128, 0,  128,  128}, { 60,  120}}, //6 left 2
	
	{BF_ArcMain_BF1, {  0, 128,  128,  128}, { 60,  120}}, //7 down 1
	{BF_ArcMain_BF1, {  128,   128,  128,  128}, { 60,  120}}, //8 down 2
	
	{BF_ArcMain_BF2, { 0,   128,  128,  128}, { 60,  120}}, //9 up 1
	{BF_ArcMain_BF2, {  128,  128,  128,  128}, { 60,  120}}, //10 up 2
	
	{BF_ArcMain_BF2, {  0,    0, 128,  128}, { 60, 120}}, //11 right 1
	{BF_ArcMain_BF2, {  128,   0, 128,  128}, { 60, 120}}, //12 right 2
	
	{BF_ArcMain_BF3, {103,   0,  128,  128}, { 60, 120}}, //13 peace 1
	{BF_ArcMain_BF3, {  0, 103, 128,  128}, { 60, 120}}, //14 peace 2
	{BF_ArcMain_BF3, {105, 106, 128,  128}, { 60, 120}}, //15 peace 3
	
	{BF_ArcMain_BF4, {  0,   0, 128, 128}, { 60, 120}}, //16 sweat 1
	{BF_ArcMain_BF4, {128,   0, 128, 128}, { 60, 120}}, //17 sweat 2
	{BF_ArcMain_BF4, {  0, 128, 128, 128}, { 60, 120}}, //18 sweat 3
	{BF_ArcMain_BF4, {128, 128, 128, 128}, { 60, 120}}, //19 sweat 4
	
	{BF_ArcMain_BF5, {  0,   128,  128,  128}, { 60, 120}}, //20 left miss 1
	{BF_ArcMain_BF5, { 128,   128,  128,  128}, { 60, 120}}, //21 left miss 2
	
	{BF_ArcMain_BF5, {  0,   0,  128,  128}, { 60, 120}}, //22 down miss 1
	{BF_ArcMain_BF5, { 128, 0,  128,  128}, { 60, 120}}, //23 down miss 2
	
	{BF_ArcMain_BF6, {  0,   128,  128,  128}, { 60, 120}}, //24 up miss 1
	{BF_ArcMain_BF6, { 128,   128,  128,  128}, { 60, 120}}, //25 up miss 2
	
	{BF_ArcMain_BF6, {  0, 0,  128,  128}, { 60, 120}}, //26 right miss 1
	{BF_ArcMain_BF6, {128, 0, 128,  128}, { 60, 120}}, //27 right miss 2
};
...
static const Animation char_bf_anim[PlayerAnim_Max] = {
	...
	{1, (const u8[]){ 4, 21, 21, 22, ASCR_BACK, 1}},     //PlayerAnim_LeftMiss
	{1, (const u8[]){ 6, 19, 19, 20, ASCR_BACK, 1}},     //PlayerAnim_DownMiss
	{1, (const u8[]){ 8, 23, 23, 24, ASCR_BACK, 1}},     //PlayerAnim_UpMiss
	{1, (const u8[]){10, 25, 25, 26, ASCR_BACK, 1}},     //PlayerAnim_RightMiss
	
	{2, (const u8[]){12, 13, 14, ASCR_BACK, 1}},         //PlayerAnim_Peace
	{2, (const u8[]){15, 16, 17, 18, ASCR_REPEAT}},      //PlayerAnim_Sweat
...
void Char_BF_SetAnim(Character *character, u8 anim)
{
	...
	switch (anim)
	{
		case PlayerAnim_Dead0:
			...
			character->focus_y = FIXED_DEC(-60,1);
...
Character *Char_BF_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		...
		"jb5.tim",   //BF_ArcMain_BF3
		"jb6.tim",   //BF_ArcMain_BF4
