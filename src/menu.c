		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					...
					case 7:
						menu.font_bold.draw(&menu.font_bold, "NOONE LMAO",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_4, "FILLER WEEK LMAO", {"TUTORIAL", NULL, NULL}},
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_4, 0xFFFC96D7, "TUTORIAL"},
